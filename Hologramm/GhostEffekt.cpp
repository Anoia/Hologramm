...
void GhostEffekt::updateEffekt(Mat &firstFrame, Mat &currentFrame, Mat &mask, Mat &output){
	...
	blend(output, firstFrame, output, 0.5);
...
*/
void GhostEffekt::applyEffektToCurrentFrame(Mat &currentFrame, Mat &output){
...
*/
void GhostEffekt::blend(Mat &input1, Mat &input2, Mat &output, double alpha){
...
*/
void GhostEffekt::calculateEffektMat(Mat &output){
